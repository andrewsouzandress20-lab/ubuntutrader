...
async function collectAndSendSignal(assetSymbol) {
    try {
        ...
        await sendTelegramSignal(assetSymbol, 'COMPRA', // ou lógica baseada nos dados
...
function scheduleSignal(assetSymbol, openTime, days) {
