...
const TradingChart = ({ asset }) => {
    ...
    return (_jsx("div", { className: "w-full h-full bg-[#02040a] relative", ref: containerRef, children: _jsxs("div", { className: "absolute inset-0 flex flex-col items-center justify-center text-slate-700 bg-[#02040a] z-0", children: [_jsx("i", { className: "fas fa-circle-notch fa-spin text-xl mb-3 text-indigo-500/50" }), _jsxs("span", { className: "text-[9px] font-black uppercase tracking-[0.3em] opacity-40", children: ["Conectando Terminal TradingView (", asset.symbol, ")..."] })] }) }));
};
